...
`;
    ...
    describe('Testing single line source and destination', () => {
      test('Should be able to compare', () => {
        const source = 'hello world';
        const destination = 'helo wrld hi';
        const { formattedSource, formattedDestination } = diffLines({ source, destination });
        expect(formattedSource).toStrictEqual(
          '<div class="sanduk-compare-tool-line sanduk-del-op "><span class="sanduk-compare-tool-line-number">1</span>hel<span class="sanduk-diff-del-op">l</span>o w<span class="sanduk-diff-del-op">o</span>rld</div>'
        );
        expect(formattedDestination).toStrictEqual(
          '<div class="sanduk-compare-tool-line sanduk-ins-op"><span class="sanduk-compare-tool-line-number">1</span>helrld<span class="sanduk-diff-ins-op"> hi</span></div>'
        );
      });
    });
  });
