...
function getHtml({ prefix }) {
  return `<li class="nav-item">
    <a class="nav-link" href="#" id="${prefix}-increase-font-size-btn"><i title="Increase font size" class="bi-zoom-in"></i></a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="#" id="${prefix}-decrease-font-size-btn"><i title="Decrease font size" class="bi-zoom-out"></i></a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="#" id="${prefix}-reset-font-size-btn"><i title="Reset font size" class="bi-arrow-counterclockwise"></i></a>
  </li>`;
}
