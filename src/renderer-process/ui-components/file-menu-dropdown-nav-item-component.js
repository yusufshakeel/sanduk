...
function getHtml({ prefix }) {
  return `<li class="nav-item dropdown">
    ...
    <ul class="dropdown-menu" aria-labelledby="${prefix}-file-menu-dropdown">
      ...
      <li><a class="dropdown-item" href="#" id="${prefix}-file-menu-dropdown-save-btn">Save</a></li>
      <li><hr class="dropdown-divider"></li>
      <li><a class="dropdown-item" href="#" id="${prefix}-file-menu-dropdown-close-btn">Close File</a></li>
    </ul>
  </li>`;
}
